	...
	<div class="bg-container" smoothscroll role="main">
		<section id="contact">
			<div class="container">
				...
				<h1 class="h1 text-reveal" scroll="reveal"><?=$page['headline']?></h1>
			</div>
			...
			<div id="contact-container">
				<div class="container" id="contact-details">
					<div class="fade-up fade-up-para-lg" scroll="reveal">
						...
						<p class="para sm"><a href="mailto:<?=$page['contact']['email']?>"><?=$page['contact']['email']?></a></p>
					</div>
					<div class="fade-up fade-up-para-lg" scroll="reveal">
				...
				<figure scroll="parallax">
					<img <?=srcset($page['image'], 'large')?>
						 sizes="(min-width: 768px) 49vw, 100vw"
						 alt="<?=$page['headline']?>" class="cover" scroll="image">
				</figure>
				
				<div class="ticker red" scroll="ticker">Let’s Connect</div>
				
				<div class="container fade-up fade-up-para-lg" id="contact-address" scroll="reveal">
					<h2 class="para lg">Our Address</h2>
					<p class="para sm pre"><?=$page['contact']['address']?></p>
				</div>
			</div>
		</section>
		...
		<section id="contact-form">
			<div class="container fade-up fade-up-para-lg" scroll="reveal">
				<p class="para lg"><?=$page['form_headline']?></p>
				
				<h2 class="small-header">Fill out the form below</h2>
				
				<div class="form-container">
					<form method="post" handler="<?=admin_url('admin-ajax.php')?>" controller="form" role="form" id="contact-us-form" >
						<fieldset>
							<input type="text" class="form-input" name="name" placeholder="Your Name" aria-label="Your Name">
						</fieldset>
						<fieldset>
						...
						<fieldset class="block">
							<textarea class="form-input" name="message" placeholder="Message" aria-label="Message"></textarea>
						</fieldset>
						
						<button type="submit" class="button text-reveal clickable" scroll="reveal" aria-label="Submit Form">
							<strong>Email
									Us Now</strong>
						</button>
					...
					<p class="para sm"><?=$page['form_thank_you_message']?></p>
				</div>
			</div>
		</section>
	</div>
